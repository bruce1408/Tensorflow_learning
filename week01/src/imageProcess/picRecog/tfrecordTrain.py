...
train_data, train_label, test_data, test_label = rawImageData()
...
logits_test = conv_net(X_test, 5, dropout, reuse=True, is_training=False)
# Define loss and optimizer (with train logits, for dropout to take effect)
# Y_train = tf.one_hot(Y_train, 5)
# print(Y_)
# loss_op = tf.reduce_mean(-tf.reduce_sum(Y_train * tf.log(logits_train), reduction_indices=[1]))
