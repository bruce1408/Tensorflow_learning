...
embedding = tf.Variable(
    tf.stack(mnist.test.images[:image_num]),  trainable=False,  name='embedding')
...
projector_writer = tf.summary.FileWriter(
    DIR + 'projector/projector', sess.graph)
...
for i in range(max_steps):
    ...
    summary, _ = sess.run([merged, train_step], feed_dict={
                          x: batch_xs, y: batch_ys}, options=run_options, run_metadata=run_metadata)
